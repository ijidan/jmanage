...
func BlogAuthMgr(db *gorm.DB) *_BlogAuthMgr {
	...
	return &_BlogAuthMgr{_BaseMgr: &_BaseMgr{DB: db.Table("blog_auth"), isRelated: globalIsRelated, ctx: ctx, cancel: cancel, timeout: -1}}
}
...
// WithID id获取
func (obj *_BlogAuthMgr) WithID(id uint32) Option {
...
// GetFromID 通过id获取内容
func (obj *_BlogAuthMgr) GetFromID(id uint32) (result BlogAuth, err error) {
...
func (obj *_BlogAuthMgr) GetBatchFromID(ids []uint32) (results []*BlogAuth, err error) {
...
func (obj *_BlogAuthMgr) FetchByPrimaryKey(id uint32) (result BlogAuth, err error) {
	err = obj.DB.WithContext(obj.ctx).Table(obj.GetTableName()).Where("id = ?", id).Find(&result).Error
