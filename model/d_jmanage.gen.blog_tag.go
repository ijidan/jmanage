...
func BlogTagMgr(db *gorm.DB) *_BlogTagMgr {
	...
	return &_BlogTagMgr{_BaseMgr: &_BaseMgr{DB: db.Table("blog_tag"), isRelated: globalIsRelated, ctx: ctx, cancel: cancel, timeout: -1}}
}
...
// WithID id获取
func (obj *_BlogTagMgr) WithID(id uint32) Option {
...
func (obj *_BlogTagMgr) WithCreatedOn(createdOn int) Option {
...
func (obj *_BlogTagMgr) WithModifiedOn(modifiedOn int) Option {
...
func (obj *_BlogTagMgr) WithDeletedOn(deletedOn uint32) Option {
	return optionFunc(func(o *options) { o.query["deleted_on"] = deletedOn })
}

// WithState state获取 状态 0为禁用、1为启用
func (obj *_BlogTagMgr) WithState(state int8) Option {
...
// GetFromID 通过id获取内容
func (obj *_BlogTagMgr) GetFromID(id uint32) (result BlogTag, err error) {
...
func (obj *_BlogTagMgr) GetBatchFromID(ids []uint32) (results []*BlogTag, err error) {
...
func (obj *_BlogTagMgr) GetFromCreatedOn(createdOn int) (results []*BlogTag, err error) {
	err = obj.DB.WithContext(obj.ctx).Table(obj.GetTableName()).Where("created_on = ?", createdOn).Find(&results).Error

	return
}

// GetBatchFromCreatedOn 批量唯一主键查找 创建时间
func (obj *_BlogTagMgr) GetBatchFromCreatedOn(createdOns []int) (results []*BlogTag, err error) {
...
// GetBatchFromCreatedBy 批量唯一主键查找 创建人
...
func (obj *_BlogTagMgr) GetFromModifiedOn(modifiedOn int) (results []*BlogTag, err error) {
	err = obj.DB.WithContext(obj.ctx).Table(obj.GetTableName()).Where("modified_on = ?", modifiedOn).Find(&results).Error

	return
}

// GetBatchFromModifiedOn 批量唯一主键查找 修改时间
func (obj *_BlogTagMgr) GetBatchFromModifiedOn(modifiedOns []int) (results []*BlogTag, err error) {
...
// GetBatchFromModifiedBy 批量唯一主键查找 修改人
...
func (obj *_BlogTagMgr) GetFromDeletedOn(deletedOn uint32) (results []*BlogTag, err error) {
	err = obj.DB.WithContext(obj.ctx).Table(obj.GetTableName()).Where("deleted_on = ?", deletedOn).Find(&results).Error

	return
}

// GetBatchFromDeletedOn 批量唯一主键查找
func (obj *_BlogTagMgr) GetBatchFromDeletedOn(deletedOns []uint32) (results []*BlogTag, err error) {
...
func (obj *_BlogTagMgr) GetFromState(state int8) (results []*BlogTag, err error) {
	err = obj.DB.WithContext(obj.ctx).Table(obj.GetTableName()).Where("state = ?", state).Find(&results).Error

	return
}

// GetBatchFromState 批量唯一主键查找 状态 0为禁用、1为启用
func (obj *_BlogTagMgr) GetBatchFromState(states []int8) (results []*BlogTag, err error) {
...
func (obj *_BlogTagMgr) FetchByPrimaryKey(id uint32) (result BlogTag, err error) {
	err = obj.DB.WithContext(obj.ctx).Table(obj.GetTableName()).Where("id = ?", id).Find(&result).Error
