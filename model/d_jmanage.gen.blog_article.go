...
func BlogArticleMgr(db *gorm.DB) *_BlogArticleMgr {
	...
	return &_BlogArticleMgr{_BaseMgr: &_BaseMgr{DB: db.Table("blog_article"), isRelated: globalIsRelated, ctx: ctx, cancel: cancel, timeout: -1}}
}
...
// WithID id获取
func (obj *_BlogArticleMgr) WithID(id int) Option {
	return optionFunc(func(o *options) { o.query["id"] = id })
}

// WithTagID tag_id获取 标签ID
func (obj *_BlogArticleMgr) WithTagID(tagID int) Option {
...
func (obj *_BlogArticleMgr) WithModifiedOn(modifiedOn int) Option {
...
func (obj *_BlogArticleMgr) WithDeletedOn(deletedOn uint32) Option {
...
// GetFromID 通过id获取内容
func (obj *_BlogArticleMgr) GetFromID(id int) (result BlogArticle, err error) {
...
func (obj *_BlogArticleMgr) GetBatchFromID(ids []int) (results []*BlogArticle, err error) {
...
func (obj *_BlogArticleMgr) GetFromTagID(tagID int) (results []*BlogArticle, err error) {
...
func (obj *_BlogArticleMgr) GetBatchFromTagID(tagIDs []int) (results []*BlogArticle, err error) {
...
func (obj *_BlogArticleMgr) GetFromModifiedOn(modifiedOn int) (results []*BlogArticle, err error) {
...
func (obj *_BlogArticleMgr) GetBatchFromModifiedOn(modifiedOns []int) (results []*BlogArticle, err error) {
...
func (obj *_BlogArticleMgr) GetFromDeletedOn(deletedOn uint32) (results []*BlogArticle, err error) {
...
func (obj *_BlogArticleMgr) GetBatchFromDeletedOn(deletedOns []uint32) (results []*BlogArticle, err error) {
...
// GetBatchFromState 批量唯一主键查找 状态 0为禁用1为启用
...
func (obj *_BlogArticleMgr) FetchByPrimaryKey(id int) (result BlogArticle, err error) {
	err = obj.DB.WithContext(obj.ctx).Table(obj.GetTableName()).Where("id = ?", id).Find(&result).Error
