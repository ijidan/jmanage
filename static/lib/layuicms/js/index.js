			...
			content : '<div class="skins_box">'+
						'<form class="layui-form">'+
							...
							'<div class="layui-form-item skinBtn">'+
								'<a href="" class="layui-btn layui-btn-small layui-btn-normal" lay-submit="" lay-filter="changeSkin">确定更换</a>'+
								'<a href="" class="layui-btn layui-btn-small layui-btn-primary" lay-submit="" lay-filter="noChangeSkin">我再想想</a>'+
							'</div>'+
						'</form>'+
					'</div>',
	...
	function lockPage(){
		layer.open({
			...
			content : '	<div class="admin-header-lock" id="lock-box">'+
							'<div class="admin-header-lock-img"><img src="'+userInfo.headurl+'"/></div>'+
							'<div class="admin-header-lock-name" id="lockUserName">'+userInfo.enname+'</div>'+
							'<div class="input_btn">'+
